...
public class LeadsDto {
    ...
    public LeadsDto(Long id, String client_name, String company, String designation, String assigned_from,
            String assigned_to, String priority, String status, LocalDate created, LocalDate follow_up,
            String meeting_type, String phone, String email, String city, String address, Long value,
            String lead_source, String comments, String event_details) {
        this.id = id;
